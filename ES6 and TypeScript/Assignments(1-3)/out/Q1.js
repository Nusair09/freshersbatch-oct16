...
userFriends("Nusair", "Mohsin", "Srija", "Prajwal");
//  //ans C.
...
var nameList = ["Nusair", "Mohsin", "Srija", "Prajwal", "mallu"];
...
var SavingAccountObj = new SavingAccount(11, "Nusair", 9000, 10);
console.log(SavingAccountObj.getBalance());
var CurrentAccountObj = new CurrentAccount(11, "Basha", 70000, 100);
