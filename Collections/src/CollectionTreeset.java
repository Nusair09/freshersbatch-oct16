...
public class CollectionTreeset {
	public static void main(String[] args)
	{
		...
		if(select.equals("a"))
		{
			...
			emp.add(new Employee(101,"Nusair","CSE",100000));
            emp.add(new Employee(102,"Shivamani","ECE",75000));
            emp.add(new Employee(103,"Basha","CSE",40000));
            emp.add(new Employee(104,"Rawal","MSC",80000));
            emp.add(new Employee(105,"Moshin","EEE",60000));
            emp.add(new Employee(106,"Hassan","ECE",85000));
            emp.add(new Employee(107,"Usman","MCA",45000));
            emp.add(new Employee(108,"Ram","CSE",95000));
            emp.add(new Employee(109,"Sam","ECE",110000));
            emp.add(new Employee(110,"Sindhu","EEE",55000));
